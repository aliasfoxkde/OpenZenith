      ...
      >
        ...
        <div className="ab-body">
          ...
          <p className="sub">
            ...
            APIs &mdash; powered by NASA SRTM 30m data and served on Cloudflare&apos;s global edge network.
          </p>
          ...
          <h2>Mission</h2>
          <p>
            OpenZenith exists to make elevation and geospatial data accessible to everyone. No API keys, no rate limits
            on basic queries, no paywalls. Whether you&apos;re building a hiking app, researching terrain, or just
            curious about the elevation where you stand &mdash; the data is free and fast.
          </p>
          ...
          >
            <div className="ab-card">
              ...
              <h3>Elevation API</h3>
              <p>
                Single-point and batch elevation queries. Bilinear interpolation for smooth results from NASA SRTM 30m
                DEM tiles.
              </p>
            </div>
            <div className="ab-card">
            ...
            <div className="ab-card">
              ...
              <p>
                CesiumJS-powered 3D globe with real-time data overlays: earthquakes, flights, satellites, natural
                events, and weather.
              </p>
            </div>
            <div className="ab-card">
          ...
          <h2>Get Involved</h2>
          <p>
            OpenZenith is open source under the MIT license. Contributions are welcome &mdash; whether it&apos;s new
            data sources, bug fixes, feature requests, or documentation improvements. Visit the{" "}
