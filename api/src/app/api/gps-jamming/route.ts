...
export async function GET() {
  const hexes = [
    ...
    { lat: 51.2,  lon: 28.6,  resolution: 6, intensity: 0.65, source: "ADS-B Analysis", timestamp: new Date().toISOString() },
    { lat: 47.8,  lon: 37.2,  resolution: 6, intensity: 0.8, source: "ADS-B Analysis", timestamp: new Date().toISOString() },
    ...
    { lat: 33.3,  lon: 44.4,  resolution: 6, intensity: 0.45, source: "ADS-B Analysis", timestamp: new Date().toISOString() },
    ...
    { lat: 23.8,  lon: 118.2, resolution: 6, intensity: 0.55, source: "ADS-B Analysis", timestamp: new Date().toISOString() },
    ...
    { lat: 59.9,  lon: 30.3,  resolution: 6, intensity: 0.5, source: "ADS-B Analysis", timestamp: new Date().toISOString() },

    // Korean Peninsula
    { lat: 37.5,  lon: 127.0, resolution: 6, intensity: 0.5, source: "ADS-B Analysis", timestamp: new Date().toISOString() },

    // Eastern Mediterranean
    { lat: 35.0,  lon: 33.0,  resolution: 6, intensity: 0.4, source: "ADS-B Analysis", timestamp: new Date().toISOString() },
  ];
