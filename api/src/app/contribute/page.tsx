...
export default function ContributePage() {
  ...
  return (
    <div className="ct-wrap" style={{ background: dark ? "#0a0a0a" : "#fafafa", color: dark ? "#e5e5e5" : "#171717" }}>
      ...
      <div className="ct-body">
        ...
        >
          ...
          <div className="ct-card">
            ...
            <p>
              Upload your data or open a pull request with a proposal. Include documentation of the data source, update
        ...
        <div className="ct-api-ref">
          ...
          <div>
            {" "}
            headers: &#123; <span className="str">"Access-Control-Allow-Origin"</span>: <span className="str">"*"</span>{" "}
            &#125;,
          </div>
          <div> &#125;);</div>
