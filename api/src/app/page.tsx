...
export default function Home() {
  ...
  const [sampleLocations] = useState(() => pickRandomLocations(4));
  ...
  return (
    <div style={{ background: bg, color: text, minHeight: "100vh", fontFamily: "inherit" }}>
      ...
      {/* Hero */}
      <section style={{ maxWidth: W, margin: "0 auto", padding: "3rem 1.5rem 1rem", textAlign: "center" }}>
        <div
          style={{
            display: "inline-flex",
            alignItems: "center",
              ...
              >
                ...
                >
                  <span style={{ color: accent, fontWeight: 600, fontSize: "1.1rem" }}>
                    {result.elevation !== null ? `${result.elevation.toLocaleString()}m` : "null"}
                  </span>
