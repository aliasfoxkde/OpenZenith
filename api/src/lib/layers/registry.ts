...
export const LAYERS: readonly LayerDefinition[] = [
  ...
  /* ── Intelligence & Security ───────────────────────────── */
  {
    ...
    description: "Hex-grid visualization of GPS interference/jamming zones detected via ADS-B analysis",
    defaultEnabled: false,
    accent: "#ff4444",
  },
  {
    ...
    category: "intelligence",
    description: "Day/night terminator line showing illuminated vs dark portions of Earth",
    defaultEnabled: false,
    accent: "#fbbf24",
  },
];
