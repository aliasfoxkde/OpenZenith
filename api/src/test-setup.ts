...
vi.mock("@/lib/cache", () => ({
  ...
  CACHE_TTL: { FLIGHTS: 300, MILITARY: 30, EARTHQUAKES: 60, RADAR: 120, WARNINGS: 120, VESSELS: 60, NLNOG: 3600, ELEVATION: 86400, BATHYMETRY: 86400, WATERWAYS: 3600, GEOCODE: 86400 },
}));
